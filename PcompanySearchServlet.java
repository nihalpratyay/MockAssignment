...
@WebServlet("/PcompanySearchServlet")
public class PcompanySearchServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Query query1=manager.createQuery("from ProductDetailsDTO where pCompany='"+pcompany+"'");
		...
		if(count==0) {
		pw.print("<p style='color:red'>No Products Available of this company</p>");
		RequestDispatcher rd=request.getRequestDispatcher("pcompany.html");
